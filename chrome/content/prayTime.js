...
prayTime.js: Prayer Times Calculator (ver 1.2.2)
...
//------------------- Calc Method Parameters --------------------
	...
	*/
	...
	this.methodParams[this.Tehran]	= new Array(17.7, 0, 4.5, 0, 14);		
	...
	this.getDatePrayerTimes = function(year, month, day, latitude, longitude, timeZone)
	{
		this.lat = latitude;
		this.lng = longitude; 
	...
	// return prayer times for a given date
	this.getPrayerTimes = function(date, latitude, longitude, timeZone)
	{
	...
	this.setCalcMethod = function(methodID)
	{
		this.calcMethod = methodID;
	}

	// set the juristic method for Asr
	this.setAsrMethod = function(methodID)
	{
	...
	this.setDhuhrMinutes = function(minutes)
	{
	...
	this.setHighLatsMethod = function(methodID)
	{
		this.adjustHighLats = methodID;
	}

	// set the time format 
	this.setTimeFormat = function(timeFormat)
	{
	...
	this.computeAsr = function(step, t)  // Shafii: step=1, Hanafi: step=2
	{
		var D = this.sunDeclination(this.JDate+ t);
	...
	this.calcJD = function(year, month, day)
	{
		var J1970 = 2440588.0;
	...
	this.detectDaylightSaving = function(date) 
	{
	...
	this.effectiveTimeZone = function(year, month, day, timeZone)
	{
...
//---------------------- PrayTimes.Calc Object -----------------------

PrayTimes.calc = new PrayTimes.Calc();
